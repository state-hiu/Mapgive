...
Particularly, this guide is for staff at Post looking to implement MapGive projects, and their bureau colleagues advising on innovative diplomatic engagements. The <a  href="#resources">Resources</a> section details all concepts, considerations and logistics. <!-- Leadership will be well served by the [Executive Summary]({{site.baseurl}}/en/intro/exec-summary/), to understand the strategic value and resource requirements of MapGive. --> The guide, especially the <a href="#cases">Case Studies</a>, can also facilitate supportive connections for MapGive projects between Posts.
