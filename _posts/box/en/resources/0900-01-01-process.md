...
This guide focuses on Mapathon events, but there are [Resources](#resources) which cover field projects in more detail, especially the [OpenCities Guide](http://www.opencitiesproject.org/guide/). Written in spanish, the [Piura mini-site's materials section](https://mapgive.state.gov/events/piura/materiales/) contains some good guides on field mapping tools. Get in touch with the MapGive team, and we can discuss more.
